# FIND-CKD Correspondence 投稿文件：Cover Letter 與作者資訊欄位

> 配合主稿：`評論短信 FIND-CKD.md` §一（選項 B，171 words、2 refs）。
> `【】` 內為**待您填入**的個人資料；其餘文字可直接使用。
> NEJM Correspondence 走線上投稿系統（不寄給原作者），cover letter 簡短即可——編輯真正審的是信件本身。
...
## 二、作者資訊欄位（依 NEJM Correspondence 規格：≤3 位作者、每人 1 個 affiliation、1 位通訊作者）
...
### 3.1 Conflict of interest（每位作者都要填）

逐項檢視並如實申報，特別是：

- [ ] 是否收受 **Bayer**（finerenone/Kerendia 原廠）之演講費、顧問費、差旅、研究經費？
- [ ] 是否收受其他 MRA／SGLT2i／腎臟病相關藥廠（AstraZeneca、Boehringer Ingelheim、Novartis 等）酬金？
- [ ] 是否參與 FIND-CKD／FIDELIO／FIGARO／CONFIDENCE 任一試驗？
- [ ] 無上述情形 → 申報 "No potential conflict of interest relevant to this letter."
...
- [ ] **Originality**：本信內容未曾發表、未同時投稿他處（含社群媒體、部落格、preprint——NEJM 決定前不得公開同一內容）。
- [ ] **Authorship**：所有列名作者皆實質參與並核可最終版本；作者人數 ≤3。
- [ ] **Funding**：本信撰寫未接受任何資助（如屬實）→ "No funding was received for this work."

---

## 四、投稿系統操作備忘（送出前最後 5 分鐘）

1. Article type 選 **Letter to the Editor / Correspondence**，target article 搜尋 **NEJMoa2604625**——**若系統搜不到或不可選，即投稿窗口已關**，改走 correction inquiry（見主稿 §4.2 行動順序）。
2. Title 欄：**Hyperkalemia-Related Hospitalization in FIND-CKD**
3. 正文貼主稿選項 B（171 words）；references 2 篇（頁碼壓縮式 `533-45`、`2375-86`）。
4. 貼上前用系統的字數計算器再驗一次 ≤175（各家計數規則略有出入，若超限先刪 "likewise"、再刪 "(0.9%)/(0.6%)" 其中一組百分比）。
5. Cover letter 貼本檔 §一（填妥【】）。
6. 送出後把 submission ID 記回本檔：【 】

---

*本檔由 AI 協助生成；個人資料欄位空白處由作者本人填寫並核對。*
